...
<body>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
                ...
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('client.directory')}}">Danh mục</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="modal fade bg-white" id="templatemo_search" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <form action="{{route('client.directory')}}" method="get" class="modal-content modal-body border-0 p-0">
                @csrf
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">Book Online</h2>
